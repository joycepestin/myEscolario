    ...
    return (
        <Fragment>
                ...
                <div class="headline-container">
                    ...
                    <li class="headline1"><a href="features.html"><h1>headline headline <br />headline</h1><h3 class="byline">byline</h3></a></li>
                </div>
                ...
                <div class="text-container">
                    ...
                    <div class="link-container">
                        <li><a href="literary-photo.html" id="article-link">read full article</a></li>
                    </div>
                ...
                <div class="text-container2">
                    ...
                    <div class="link-container2">
                        <li><a href="literary-nophoto.html" id="article-link">read full article</a></li>
                    </div>
                </div>
            </div>
        </Fragment>
